    ...
    <section class="xs-banner-sec xs-banner-v2-sec owl-carousel banner-slider">
      <div class="banner-slider-item banner-item1" id="banner">
        <div class="slider-table">
            ...
            >
              <div class="col-lg-10 offset-lg-1">
                <div class="banner-content text-center">
                  <h2>
                    We are a leading supplier of<br />Coffee & Coconut
                    Sugar
                  </h2>
                  <p>Tasty and healthy are a must, not an option.</p>
                  <div class="xs-btn-wraper">
                    <a href="/greenbeans" class="xs-btn"> Our Products </a>
                    <a href="#quote" class="xs-btn fill"> Get Quote </a>
                  </div>
                  <!-- .xs-btn-wraper END -->
                </div>
          ...
          <!-- .slider table cell end -->
        </div>
        <!-- .slider table end -->
      </div>
      <!-- .xs-welcome-content END --><!-- .xs-welcome-content END -->
    </section>
    <!-- End banner section -->
      ...
      <div class="container">
          ...
          <div class="col-lg-12">
            <div class="section-title-item section-title-v2-item">
              <h2 class="section-title">
                <span class="xs-title">About Us</span><em>Who</em> we are?
              </h2>
        ...
        <div class="row">
          <div class="col-lg-2 col-md-12">
            <div
              class="nav flex-column about-tabs-menu"
              id="v-pills-tab"
              role="tablist"
                    ...
                    <div class="col-md-7">
                      <div class="about-tabs-content">
                        ...
                        <p style="text-align: justify">
                          ...
                          <b>Coffee Bean and Coconut Sugar</b>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7 align-self-center">
                      <div class="about-tabs-content">
                        <h4>Caring</h4>
                        <p>
                          Sagittis sem blandit tempor donec ridiculus bibendum
                          adipiscing pellentesque sollicitudin, interdum aptent
                          arcu rutrum penatibus sociis. Hendrerit feugiat
                          lobortis hendrerit. Auctor tortor.
                        </p>
                        <ul>
                          <li>
                            <i class="icon icon-checked2"></i>
        ...
        <div class="row">
          <div class="col-lg-7 xs-padding-0 align-self-center">
            <div class="video-item">
              ...
              <a
                href="https://www.youtube.com/watch?v=vlEJv25qIc4"
          ...
          >
            <div class="call-to-action-v2">
              <div class="call-back-content">
                <h3>
                  <i class="icon icon-user-1"></i> Get
                  <span>Quote</span>
                </h3>
                <br />
                <form class="call-back-form">
                  ...
                  <div class="form-group call-back-btn">
                    <button
                      type="submit"
                      name="submit"
                      class="xs-btn xs-v2-btn"
                    >
                      Submit
                    </button>
                    <label class="call-us-number"
                      >Or Call US -
                      <span
                        ><a style="color: #489f10" href="tel:081260774365"
                          >+6281260774365</a
                        ></span
                      ></label
                    >
