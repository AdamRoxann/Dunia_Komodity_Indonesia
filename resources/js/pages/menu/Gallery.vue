<template>
  <div>
    <section
      ...
      style="background-image:url('/assets/images/our-project/banner.jpg')"
    >
      <div class="banner-table">
        <div class="banner-table-cell">
          <div class="container">
            <div class="banner-inner-content">
              <h2 class="banner-inner-title">Products Gallery</h2>
    ...
    <!-- header team section -->
    <section
      class="gallery-sec recent-work-sec our-project-sec section-padding"
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
    ...
    <section
      class="ready-to-contact section-padding"
      ...
      <div class="container">
        <div class="col-lg-8 offset-lg-2">
          <div class="ready-to-contact-content">
            ...
            <a href="#" class="xs-btn fill">CONTACT US</a>
          </div>
        </div>
      </div>
      <!-- .container end -->
